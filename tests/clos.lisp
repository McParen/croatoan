    ...
    (let* ((pos (list (round (/ (.height scr) 2)) (round (/ (.width scr) 2))))
      ...
      (event-case (scr event)
        ...
        ((nil)
         ...
         (setf ch (cond ((equal dir dir-prev) (if (= (car dir) 0) :hline :vline))
                        ((and (equal dir-prev '(1  0)) (equal dir '(0 -1))) :lrcorner)
                        ((and (equal dir-prev '(1  0)) (equal dir '(0  1))) :llcorner)
                        ((and (equal dir-prev '(0  1)) (equal dir '(-1 0))) :lrcorner)
                        ((and (equal dir-prev '(0  1)) (equal dir '(1  0))) :urcorner)
                        ((and (equal dir-prev '(-1 0)) (equal dir '(0 -1))) :urcorner)
                        ((and (equal dir-prev '(-1 0)) (equal dir '(0  1))) :ulcorner)
                        ((and (equal dir-prev '(0 -1)) (equal dir '(-1 0))) :llcorner)
                        ((and (equal dir-prev '(0 -1)) (equal dir '(1  0))) :ulcorner)))
         (add-char scr ch)
