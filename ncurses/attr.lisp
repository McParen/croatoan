...
(cffi:defcfun ("attr_get"    attr-get)    :int              (attrs (:pointer attr_t)) (pair (:pointer :short)) (opts (:pointer :void)))
(cffi:defcfun ("wattr_get"   wattr-get)   :int (win window) (attrs (:pointer attr_t)) (pair (:pointer :short)) (opts (:pointer :void)))

(cffi:defcfun ("attr_off"    attr-off)    :int              (attrs attr_t)               (opts (:pointer :void)))
(cffi:defcfun ("wattr_off"   wattr-off)   :int (win window) (attrs attr_t)               (opts (:pointer :void)))
(cffi:defcfun ("attr_on"     attr-on)     :int              (attrs attr_t)               (opts (:pointer :void)))
(cffi:defcfun ("wattr_on"    wattr-on)    :int (win window) (attrs attr_t)               (opts (:pointer :void)))
(cffi:defcfun ("attr_set"    attr-set)    :int              (attrs attr_t) (pair :short) (opts (:pointer :void)))
(cffi:defcfun ("wattr_set"   wattr-set)   :int (win window) (attrs attr_t) (pair :short) (opts (:pointer :void)))

(cffi:defcfun ("chgat"       chgat)       :int                                (n :int) (attr attr_t) (color :short) (opts (:pointer :void)))
(cffi:defcfun ("wchgat"      wchgat)      :int (win window)                   (n :int) (attr attr_t) (color :short) (opts (:pointer :void)))
(cffi:defcfun ("mvchgat"     mvchgat)     :int              (y :int) (x :int) (n :int) (attr attr_t) (color :short) (opts (:pointer :void)))
(cffi:defcfun ("mvwchgat"    mvwchgat)    :int (win window) (y :int) (x :int) (n :int) (attr attr_t) (color :short) (opts (:pointer :void)))
